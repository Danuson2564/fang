                     ...
                     <ul class="list-unstyled">
                        ...
                        <li class="sidebar-item">
                           <a class="nav-link sidebar-link d-flex align-items-center" href="../docs/docs-change-log.html">
                              <i class="ti ti-refresh-dot"></i>Changelog</a>
                        </li>
                     </ul>
                  </nav>
               </ul>
